...
/*
Indian Politics:
Consider the politics use case.
...
In Short, If the MP is not PM then he can be arrested by commissoner , If he is minister then can be arrested with PMs permisison.
Asma Khan17:27
akhan@craterzone.com
 */
public class Main {
